    ...
    <div className="container">
      <div className="auth-title">
        <span className="login-title">
          ...
          >
            <path
              d="M157.256 42.1453C161.643 46.3838 167.596 49 174.168 49C181.213 49 187.542 45.9871 192 41.1947L175.099 24.2329L157.256 42.1414V42.1453Z"
              fill="#8AB7FF"
            />
            <path
              d="M174.168 0C167.729 0 161.894 2.51796 157.53 6.60718L175.099 24.2407L191.75 7.5303C187.307 2.89899 181.08 0.00392817 174.168 0.00392817V0Z"
              fill="#8AB7FF"
            />
            <path
              d="M157.534 6.60718C152.758 11.0774 149.756 17.4332 149.756 24.5039C149.756 31.5746 152.641 37.6908 157.256 42.1493L175.099 24.2407L157.53 6.60718L157.534 6.60718Z"
              fill="#0059FF"
            />
            <path
              d="M103.932 14.2985V0.00785634H74.4477H55.9033V14.2985V19.743V33.798V48.7486H74.4477V33.798H92.9921V19.743H74.4477V14.2985H103.932Z"
              fill="#0059FF"
            />
            <path
              d="M74.4477 33.798H55.9033V48.7447H74.4477V33.798Z"
              fill="#8AB7FF"
            />
            <path
              d="M74.4477 14.2985H55.9033V19.743H74.4477V14.2985Z"
              fill="#8AB7FF"
            />
            <path
              d="M103.932 0.00785634H74.4477V14.2985H103.932V0.00785634Z"
              fill="#8AB7FF"
            />
            <path
              d="M92.9921 19.743H74.4477V33.8019H92.9921L92.9921 19.743Z"
              fill="#8AB7FF"
            />
            <path
              d="M48.044 0.168911H16.2547C7.29956 0.168911 0.0391397 7.43603 0 16.4158H31.7932C40.7484 16.4158 48.0088 23.6829 48.044 32.6627V0.168911Z"
              fill="#8AB7FF"
            />
            <path
              d="M0 16.4787C0 16.4551 0 16.4355 0 16.4119V16.4787Z"
              fill="#8091E6"
            />
            <path
              d="M0 16.4787V48.9057H31.9224C40.8267 48.9057 48.044 41.6622 48.044 32.7256C48.044 32.702 48.044 32.6824 48.044 32.6588H16.1256C7.22128 32.6588 0 25.4153 0 16.4787Z"
              fill="#8AB7FF"
            />
            <path
              d="M16.1217 32.6588H48.0401C48.0049 23.679 40.7445 16.4119 31.7893 16.4119H0C0 16.4355 0 16.4551 0 16.4787C0 25.4153 7.21737 32.6588 16.1217 32.6588Z"
              fill="#0059FF"
            />
            <path
              d="M98.3973 48.7486H122.543V0.00785634L98.3973 48.7486Z"
              fill="#8AB7FF"
            />
            <path
              d="M122.543 48.7486H146.692L122.543 0.00785634V48.7486Z"
              fill="#0059FF"
            />
          </svg>
        </span>
